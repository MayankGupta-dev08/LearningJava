...
public class MenuItem {
    ...
    public String toString() {
        ...
        builder.append("MenuItem [readAccessRole=").append(readAccessRole).append(", writeAccessRole=").append(writeAccessRole).append(", access=").append(access).append(", visible=").append(visible).append(", childMenus=").append(childMenus).append("]");
