...
class EagerUnionFindTest {

    private EagerUnionFind unionFind;

    @BeforeEach
    void setUp() {
        unionFind = new EagerUnionFind(10);
    }

    @Test
    void testInitialSetup() {
        for (int i = 0; i < 10; i++) {
            assertEquals(i, unionFind.find(i), "Each element should initially be its own parent.");
        }
    }
